 ...
 */
@Website
public class StorageInternalWebsite extends StorageWebsite {

    public StorageInternalWebsite() {
//        super(PathManager.getInstance().getWebDir());
        super(Environment.getExternalStorageDirectory() + "/xiezhu/aaa");
        Log.d("StorageWebsite", Environment.getExternalStorageDirectory() + "/xiezhu/aaa");
    }
}